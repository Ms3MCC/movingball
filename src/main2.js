...
pane.addBinding(params, "positionX", { min: -10, max: 14, step: 0.1 }).on("change", (ev) => {
    sphere.position.x = ev.value;
});
pane.addBinding(params, "positionY", { min: -10, max: 14, step: 0.1 }).on("change", (ev) => {
    sphere.position.y = ev.value;
});
pane.addBinding(params, "positionZ", { min: -10, max: 14, step: 0.1 }).on("change", (ev) => {
